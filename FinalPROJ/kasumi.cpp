...
{	
	...
	cout << "Output: " << std::hex << left << right << endl;
}
...
int main() {
	unsigned char key[] = {0x9a, 0xf5, 0x1b, 0xc7, 0x3d, 0x45, 0xba, 0x3a, 0x9b, 0x94, 0x5b, 0x68, 0x60, 0x55, 0xdf, 0x97};
	KeySchedule((u8 *) key);
	unsigned char in[] = {0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf0};
	Kasumi((u8 *) in);
